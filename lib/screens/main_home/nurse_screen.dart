...
class _NurseScreenState extends State<NurseScreen> {
  ...
  void showDoctorDialog(BuildContext context) {
    ...
    final tips = [
      "Pillows help patients rest better and recover faster!",
      "Proper nutrition is essential for quick recovery.",
      "A nurse's care can make all the difference in a patient's day.",
      "Remember to check vital signs regularly.",
      "Keep your medical supplies organized for efficiency!"
    ];
          ...
          child: TweenAnimationBuilder<double>(
            ...
            child: Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Dialog bubble for nurse's speech
                      Container(
                ...
                // Decorative elements (floating particles) - reduced number and position adjusted
